      ...
      <div className="main">
        <header className="header">
          <div className="header-row">
            ...
            <nav className="header-utils top-nav" aria-label="Primary">
              <a className="top-nav-link active" href="./" rel="noopener noreferrer">Explorer</a>
              <a className="top-nav-link" href="./api.html" rel="noopener noreferrer">API</a>
              <a className="top-nav-link icon" href="https://github.com/hyperfy-xyz/hyperfy-apps" target="_blank" rel="noopener noreferrer" aria-label="GitHub repository">

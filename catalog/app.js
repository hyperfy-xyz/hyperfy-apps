...
function Explorer() {
  ...
  useEffect(() => {
    ...
    const onDocClick = (e) => {
      ...
      if (navToggleRef.current?.contains(e.target)) return;
      setMobileNavOpen(false);
    };
    const onEsc = (e) => {
    ...
    <div className="layout">
      <div className="main">
        <header className="header">
          <div className="header-row">
            <div className="header-brand-row">
              <div className="title-wrap">
                ...
                <span className="title-meta">made by <a href="https://github.com/madjin" target="_blank" rel="noopener noreferrer">jin</a></span>
              </div>
              <button
            ...
            <nav id="primary-nav" className=${`header-utils top-nav ${mobileNavOpen ? "open" : ""}`} aria-label="Primary" ref=${navRef}>
              <a className="top-nav-link active" href="./" rel="noopener noreferrer" onClick=${() => setMobileNavOpen(false)}>Explorer</a>
              <a className="top-nav-link" href="./api.html" rel="noopener noreferrer" onClick=${() => setMobileNavOpen(false)}>API</a>
              <a className="top-nav-link icon" href="https://github.com/hyperfy-xyz/hyperfy-apps" target="_blank" rel="noopener noreferrer" aria-label="GitHub repository" onClick=${() => setMobileNavOpen(false)}>
          ...
          <p className="drag-callout">Drag <code>.hyp</code> files into Hyperfy</p>
        </header>
        ...
        <div className="controls">
          <div className="search-wrap">
            ...
            <input
              className="search"
              type="search"
              placeholder=${`Search ${data.counts.total} apps or authors...`}
              value=${query}
